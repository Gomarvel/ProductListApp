...
class ProductDetailWidget extends StatefulWidget {
  const ProductDetailWidget({
    Key? key,
    required this.productDocumentRef,
  }) : super(key: key);
...
class _ProductDetailWidgetState extends State<ProductDetailWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await widget.productDocumentRef!.update(createProductsRecordData());
    });
              ...
              child: Column(
                ...
                children: [
                  StreamBuilder<ProductsRecord>(
                    stream:
                        ProductsRecord.getDocument(widget.productDocumentRef!),
                    builder: (context, snapshot) {
                      ...
                      final productInfoProductsRecord = snapshot.data!;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child: Text(
                              productInfoProductsRecord.name,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child: Text(
                              productInfoProductsRecord.price.toString(),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child: Text(
                              productInfoProductsRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.productpriceControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await widget.productDocumentRef!
